    ...
    return (
      <Tree nodes={this.state.nodes} onChange={this.handleChange}>
        {({ node, style, className, ...rest }) => {
          const country =
            countries[node.id] && countries[node.id].flag.toLowerCase();
...
export default createEntry(
  ...
  <div>
    <p>
      FIFA world cup is back in 2018, in this special example the tree view is
      used to display the group stage draw results!
    </p>
