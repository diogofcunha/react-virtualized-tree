...
export default createEntry(
  ...
  <div>
    <p>
      A good example of a possible extension is creating a new handler to select
      nodes that automatically selects all the children nodes.
    </p>

    <p>
      By injecting <code>extensions</code> prop with an update type handler for
      node selection that can be achieved.
    </p>
  </div>,
  Extensions
);
