...
export default createEntry(
  ...
  <div>
    <p>
      All cells in react-virtualized-tree implement react-virtualized's
      CellMeasurer
    </p>
    <p>
      All nodes receive a measure prop that can be used to measure nodes with
      different heights like what happens in this example
    </p>
  </div>,
  NodeMeasure
);
